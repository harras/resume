...
\header{Skills}
	\begin{achievements}
		\item{\bf Programming Languages:} Proficient in Python, C, and Java; Familiar with \cpp, JavaScript, HTML/CSS, and Lisp (Scheme)
		\item{\bf Technology and Software:} Git, Node.js, MySQL, JSP, AWS (RDS and EC2), WordPress, Bootstrap, \LaTeX
	\end{achievements}
