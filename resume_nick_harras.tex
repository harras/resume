...
\subheading{Probabilistic Search Program}{}{}{}
	...
	Program written in \textbf{Python} that uses a belief state matrix and Bayesian formulas to find a particular cell in a grid, despite a ranging likelihood of false-positives.
	\end{adjustwidth}
	\begin{achievements}
