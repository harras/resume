...
\subheading
	...
	\begin{achievements}
		\item Working closely with web developers and designers to help create web sites for small businesses
		\item Utilizing \textbf{WordPress} and \textbf{HTML/CSS} in a professional setting
		\item Researching malicious \textbf{PHP} scripts that had stolen client information using steganography
	\end{achievements}
