...
\header{SKILLS}
	...
	% 	\item{\bf :}
		...
		\item{\bf IT and Workflow Tools:} Service Desk, OTRS, Slurm, git, vim, cron 
		\item{\bf Network and Security:} Nmap, Nessus, WireShark, Burp Suite, VirtualBox, OpenVPN, iptables, ssh, X2Go
...
\subheading
	...
	\begin{achievements}
		...
		\item Utilized \textbf{WordPress} and its various tools for content management across 12 or so projects
	\end{achievements}
