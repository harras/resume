...
\subheading
	...
	\begin{achievements}
		\item Utilizing \textbf{Slurm} and other command line tools to maintain various \textbf{Linux SUSE} HPC systems that scientists at NOAA's Geophysical Fluid Dynamics Lab rely on for their weather modeling
...
\header{SKILLS}
	\begin{achievements}
		...
		\item{\bf Technology and Software:} Vim, Git, bash, tcsh, Nmap, WireShark, VirtualBox, InfluxDB, MySQL, SQLite, JSP, AWS (RDS and EC2), HTML/CSS \LaTeX
