...
\subheading
	...
	\begin{achievements}
		\item Writing \textbf{Python} scripts to update an \textbf{InfluxDB} database on the status of various government HPCs
		\item Monitoring and maintaining OpenSUSE HPCs and a RHEL7 Cluster
		\item Experience with ticketing systems
	\end{achievements}
